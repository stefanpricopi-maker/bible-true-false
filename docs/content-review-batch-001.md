...
Audio-ul existent pentru aceste 3 ID-uri **nu mai corespunde** textului. Regenerare: `npm run gen:questions -- --force` (sau doar aceste ID-uri, dacă scriptul o permite), apoi `npm run sync:batch`.
